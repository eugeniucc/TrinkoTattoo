...
L.marker([47.0200287, 28.8473541], { icon: customIcon })
  .addTo(map)
  .bindPopup(
    `<div style="text-align:center; font-family:Montserrat, sans-serif; max-width:230px;">
       ...
       <p style="margin:4px 0; font-size:14px; line-height:1.5;">
          <strong style="color:#f24342;">📍 Мы переехали!</strong><br>
          ул. Тигина 65<br>
          (ниже Центрального автовокзала)<br>
          <span style="font-size:13px; color:#aaa;">Ориентир: автобусная остановка</span><br>
          <span style="font-size:13px;">Вход: вывеска "icam"</span>
       </p>
